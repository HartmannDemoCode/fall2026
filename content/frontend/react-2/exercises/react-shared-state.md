...
2. Share state between sibling components by [lifting the state](/toolbox/react/lifting-state) to a common parent.
3. Learn to handle an input form using the [`controlled component`](/toolbox/react/controlled-component) pattern.

### The lifting state principle

![Lifting state](../images/lifting-state.jpg)
