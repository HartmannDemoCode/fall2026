...
- [About the DOM](/toolbox/javascript/dom)
- [About selection elements in the DOM](/toolbox/javascript/dom-selection)
- [About manipulating the DOM a using events](/toolbox/javascript/dom-manipulation)
...
In [exercise 1](../js-basics), you used an array type and `map` and `join` functions to create an `UL` with a number of names. Use this approach + DOM manipulation to insert the `UL` somewhere in an HTML page.:

2.3.1 Create a FORM with an input field + a submit button as sketched here.  

![Add name button](../images/add-name-button.png)
{.fourth}
...
![Add name button](../images/dom-filter-cars.png)
{.half}
