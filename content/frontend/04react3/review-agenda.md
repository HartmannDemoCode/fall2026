...
vanilla typescript.
3. What is a callback function in TypeScript and when would you use one?
...
8. What is the purpose of the window object in TypeScript?
9. Explain the concept of event bubbling in TypeScript.
10. What is the scope of a variable in TypeScript? Explain the difference between global and local scope.
11. What is the spread operator in TypeScript and how does it differ from the rest operator?
