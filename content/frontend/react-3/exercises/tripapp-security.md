...
- API to use:
  - GET [https://tripapi.cphbusinessapps.dk/api/trips](https://tripapi.cphbusinessapps.dk/api/trips) (ANYONE)
  - GET [https://tripapi.cphbusinessapps.dk/api/guides](https://tripapi.cphbusinessapps.dk/api/guides) (ADMIN)
  - GET [https://tripapi.cphbusinessapps.dk/api/trips/3](https://tripapi.cphbusinessapps.dk/api/trips/3) (USER)
  - GET [https://tripapi.cphbusinessapps.dk/api/auth/login](https://tripapi.cphbusinessapps.dk/api/auth/login) (ANYONE)
...
2. Install react router in the project `npm i react-router`

3. Setup the router in `main.jsx` and setup a parent route with the App component as element surrounding all the other routes. Documentation for react router can be found [here](/toolbox/react/routing)
