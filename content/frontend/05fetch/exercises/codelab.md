...
1. Fetch data from the provided API endpoint: [https://tripapi.cphbusinessapps.dk/api/mock/trips](https://tripapi.cphbusinessapps.dk/api/trips).
...
1. When a trip is clicked, display a `Trip Details` view on the right side of the screen. Details about a trip can be found by id like this: [https://tripapi.cphbusinessapps.dk/api/mock/trips/11](https://tripapi.cphbusinessapps.dk/api/trips/2).
