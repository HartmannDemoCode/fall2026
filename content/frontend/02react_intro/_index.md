---
title: 02 Intro to React 
description: "Introduction to React and Vite for building a SPA with many components"
weight: 2
draft: false
...
0. Introduction to React and Vite
...
2. [Spread operator in TypeScript](/toolbox/javascript/js-spread-operator)
3. [Destructuring in TypeScript](/toolbox/javascript/js-destructuring)
4. [New React Project with Vite](/toolbox/react/vite)
5. [Functional Components](/toolbox/react/functional-components)
6. [Props](/toolbox/react/props)
7. [UseState](/toolbox/react/usestate)
8. [UseEffect](/toolbox/react/useeffect)
9. [Fetch (GET) in TypeScript](/toolbox/javascript/js-fetch)
10. [Fetching (GET) in React](https://react.dev/reference/react/useEffect#fetching-data-with-effects)
11. [React docs - Lifting State](https://react.dev/learn/sharing-state-between-components) or [toolbox lifting state](/toolbox/react/lifting-state)
...
3. [UseState](exercises/react-state)
4. [Lists and keys](exercises/react-lists)
5. [Todolist](exercises/react-shared-state)
...
8. [Fetch (GET) in TypeScript](/toolbox/javascript/js-fetch)
...
- [Trip and Guide exercise](exercises/codelab)



Orient yourself in this documentation:

- [Json server](/toolbox/react/json-server)
- [React Forms: Controlled Components](/toolbox/react/controlled-component)
- [React Forms: Uncontrolled Components](/toolbox/react/uncontrolled-component)
