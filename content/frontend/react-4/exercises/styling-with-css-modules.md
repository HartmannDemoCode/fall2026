...
8. **Implement light/dark mode**
   ...
   Use this [light/dark mode demo](/toolbox/react/css-theming) as a reference to implement light/dark mode in your application.
   ...
   - [CSS Modules](/toolbox/react/css-modules)
   - [Light/Dark Mode](/toolbox/react/css-theming)
