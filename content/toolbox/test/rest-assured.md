...
2. **Readable and Maintainable Tests:** The DSL (Domain-Specific Language) used in Rest Assured makes the test cases more readable and easier to maintain. For example using the [Gherkin Syntax](../gherkin) with Rest Assured:
...
![Overview](../images/javalin-test-map.png)

## Demo code for getting started with Rest Assured
...
```java
    ...
    private Map<String, IJPAEntity> entities; // find an entity by its name (e.g. "person1")
...
```
For the full code see: https://gist.github.com/Thomas-Hartmann/670b5f41edb818ed47acde565f6fb1a8#file-personressourcetest-java
