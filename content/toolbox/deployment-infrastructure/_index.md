...
5. [Installation af Java 17 på Droplet](java)
6. [Installation af Postgres 16.2 i en Docker container](postgres-setup)
7. [Tag et snapshot af din Droplet](snapshot)
8. [Deploy dit website (det gør vi først onsdag)](docker-caddy-droplet)
