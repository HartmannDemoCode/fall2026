...
`useState` can also manage more complex state like objects or arrays. However, be cautious with objects and arrays because `useState` doesn’t merge state updates automatically.
