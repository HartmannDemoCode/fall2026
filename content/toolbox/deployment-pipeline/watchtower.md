...
![Watchtower Setup](../images/watchtower.png)
{.half-right}
...
1. You will need to have a Docker Image on Docker Hub with your Javalin application. If not, then follow the [Github Actions and Docker Hub tutorial](../actions-dockerhub) tutorial first.
