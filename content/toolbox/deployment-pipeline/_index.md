...
0. [Opret dig hos Digital Ocean](/toolbox/deployment-infrastructure/digitalocean-signup)
1. [Opret (eller find din) ssh nøgle](/toolbox/deployment-infrastructure/sshkeys)
2. [Opsætning af virtuel server hos Digital Ocean](/toolbox/deployment-infrastructure/droplet)
3. [Log på Droplet første gang](/toolbox/deployment-infrastructure/logpaadroplet)
4. [Opret ny bruger i Ubuntu og konfigurer en firewall](/toolbox/deployment-infrastructure/ubuntufix)
5. [Installation af Java 17 på Droplet](/toolbox/deployment-infrastructure/java)
6. [Tag et snapshot af din Droplet](/toolbox/deployment-infrastructure/snapshot)
7. [Deploy dit website (det gør vi først onsdag)](full-pipeline)

Her er en oversigt over den overordnede system arkitektur:

![System](/toolbox/deployment-infrastructure/images/systemarchitecture.png)
