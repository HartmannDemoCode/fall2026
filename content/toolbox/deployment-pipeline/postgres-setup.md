...
draft: false
---
![Postgres Logo](../images/postgres-logo.webp)
{.half-right}
...
Now that the Postgres service is running, we can connect the `hotelAPI` service to it. Follow the [Hotel API](../hotelAPI-setup) exercise to set up the hotelAPI Javalin web application on your Digital Ocean Droplet.
