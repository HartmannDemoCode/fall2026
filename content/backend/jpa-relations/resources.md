...
- [CRUD examples with a single entity](/toolbox/java/orm/jpa-crud-example)
- [The role of the entity manager in JPA](/toolbox/java/orm/jpa-entity-manager)
- [ORM Wiki](/toolbox/java/orm/orm-wikipedia)
...
- [Setting up DAO test with test containers](/toolbox/test/dao-test)
