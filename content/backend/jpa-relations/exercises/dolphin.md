...
![Dolphin Domain Model](../images/dolphin-domain-1.jpg)

### Todo (add functionality and refactor)

1. Please consider how to implement US-1 - and do it.
2. Add a few notes to each person, and check that they are persisted correctly in the database.
