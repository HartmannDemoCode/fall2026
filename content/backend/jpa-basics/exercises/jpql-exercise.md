...
(1) You might want to create a `EmployeeDAO` class with a method for each query. And even apply the [singleton pattern](/toolbox/designpatterns/singleton) to the `EmployeeDAO` class to ensure only one instance is created.

## Remember: Always add your entity classes to the HibernateConfig

![HDJ - Her dumper jeg](../images/hdj.png)
{.half}
