...
Check for latest version here: [https://mvnrepository.com/search?q=lombok](https://mvnrepository.com/search?q=lombok).
...
our [Toolbox](/toolbox/java/deepdive/lombok) for more information.
