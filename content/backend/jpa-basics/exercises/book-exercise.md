...
1. **Set Up a Java Project:**  
   - Create a new **Maven** project. Use [JPA starter](/toolbox/java/orm/jpa-setup) if needed.
...
7. **Validate ISBN Before Persisting a Book**
   ...
   - Hint: Use the `ISBNValidator` class from the [ISBN validation exercise](/toolbox/java/orm/jpa-isbn-validation)
