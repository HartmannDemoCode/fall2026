...
![Bates hotel](../images/bates-hotel.jpg)

Based on your code from last week, you should now add **integration tests** to the project.
...
- Maybe you have seen this project in a class demo, that is similar the one we are working on. You can find the code here:
...
- In case your own hotel api is not up'n running, you can clone this one with javalin 7:

      https://github.com/HartmannDemoCode/hotel_api_dep
