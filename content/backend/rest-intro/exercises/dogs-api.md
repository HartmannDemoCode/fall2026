...
draft: false
---
![Meditative dog](../images/meditative-dog.gif)
{.half-right}
...
2. Create a new javalin server running on port 7070 that can handle the following routes representing a dog ressource:
...
9. Create a `.http` file to test the endpoints with http requests.
